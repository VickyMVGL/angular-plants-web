      ...
      <div class="col-lg-4 mb-4">
        <div class="card border-0">
          <div class="card-header position-relative border-0 p-0 mb-4">
            ...
            <div class="position-absolute d-flex flex-column align-items-center justify-content-center w-100 h-100" style="top:0;left:0;z-index:1;background:rgba(0,0,0,0.5)">
              <h3 class="text-primary mb-3">Basic</h3>
              <h1 class="display-4 text-white mb-0"><small style="font-size:22px"> $</small>49<small style="font-size:16px">/ Mo</small></h1>
            </div>
          </div>
