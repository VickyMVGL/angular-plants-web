...
@Component({
  ...
  imports: [],
  template: `
    <div class="themed-root container-fluid bg-light pt-5 pb-4">
            ...
            <div class="card border-0">
              <div class="card-header position-relative border-0 p-0 mb-4">
                ...
                >
                  ...
                  <h1 class="display-4 text-white mb-0">
                    <small style="font-size:22px"> $</small>49<small style="font-size:16px"
                      >/ Mo</small
                    >
                  </h1>
                </div>
              ...
              <div class="card-body text-center p-0">
                <ul class="list-group list-group-flush mb-4">
                  ...
                  <li class="list-group-item p-2">
                    <i class="fa fa-times text-danger mr-2"></i>Veterinary Medicine
                  </li>
                </ul>
              </div>
              <div class="card-footer border-0 p-0">
                <a href="#" class="btn btn-primary btn-block p-3" style="border-radius: 0"
                  >Signup Now</a
                >
              </div>
            </div>
            ...
            <div class="card border-0">
              <div class="card-header position-relative border-0 p-0 mb-4">
                ...
                >
                  ...
                  <h1 class="display-4 text-white mb-0"><small>$</small>99<small>/ Mo</small></h1>
                </div>
              </div>
              <div class="card-body text-center p-0">
                <ul class="list-group list-group-flush mb-4">
                  ...
                  <li class="list-group-item p-2">
                    <i class="fa fa-check text-secondary mr-2"></i>Spa & Grooming
                  </li>
                  <li class="list-group-item p-2">
                    <i class="fa fa-times text-danger mr-2"></i>Veterinary Medicine
                  </li>
              ...
              <div class="card-footer border-0 p-0">
                <a href="#" class="btn btn-secondary btn-block p-3" style="border-radius: 0"
                  >Signup Now</a
                >
              </div>
            </div>
            ...
            <div class="card border-0">
              <div class="card-header position-relative border-0 p-0 mb-4">
                ...
                >
                  ...
                  <h1 class="display-4 text-white mb-0"><small>$</small>149<small>/ Mo</small></h1>
                </div>
              </div>
              <div class="card-body text-center p-0">
                <ul class="list-group list-group-flush mb-4">
                  ...
                  <li class="list-group-item p-2">
                    <i class="fa fa-check text-secondary mr-2"></i>Veterinary Medicine
                  </li>
                </ul>
              </div>
              <div class="card-footer border-0 p-0">
