...
//         <button *ngFor="let _s of slides; let j = index"
//                 [class.active]="j === currentSlide"
//                 (click)="goTo(j)"
//                 aria-label="Go to slide {{j+1}}"></button>
//       </div>
//     </section>
//   `,
...
//   onGetQuote(): void {
//     // implementar navegación o modal según la app
...
//     this.startAutoSlide(); // reinicia temporizador para mejor UX
//   }
