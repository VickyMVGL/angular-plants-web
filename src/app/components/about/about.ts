...
@Component({
  ...
  template: `
    ...
    <section class="themed-root about-section container py-5">
      <div class="row py-5">
        <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
          ...
          <h5 class="text-muted mb-3">
            Amet stet amet ut. Sit no vero vero no dolor. Sed erat ut sea. Just clita ut stet kasd
            at diam sit erat vero sit.
          </h5>
          <p class="mb-4">
        ...
        <div class="col-lg-5">
          <div class="row px-3">
            <div class="col-12 p-0">
              <img class="img-fluid w-100" src="assets/img/about-1.jpg" alt="About image 1" />
            </div>
            <div class="col-6 p-0">
              <img class="img-fluid w-100" src="assets/img/about-2.jpg" alt="About image 2" />
            </div>
            <div class="col-6 p-0">
              <img class="img-fluid w-100" src="assets/img/about-3.jpg" alt="About image 3" />
            </div>
          </div>
        </div>
      </div>
